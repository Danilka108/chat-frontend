...
export class DialogsInfoComponent implements OnInit, OnDestroy {
    ...
    constructor(private readonly store: Store<AppState>, private readonly httpService: HttpService) {}
    ...
    ngOnInit(): void {
        this.sub = this.store
            .pipe(
                ...
                tap((receiverID) => {
                    this.isDisableToggleSidebar = receiverID === null
                })
            )
            .subscribe()
